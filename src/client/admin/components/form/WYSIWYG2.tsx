...
class WYSIWYG2 extends React.Component<IWYSIWYGProps & FieldItem & StyledComponentProps> {
  render() {
...
class MyUploadAdapter {
  ...
  constructor(props) {
    ...
    this.url = `http://localhost:3000/admin/api/uploadFile`;
  }
...
export default withStyles(styles)(WYSIWYG2);
